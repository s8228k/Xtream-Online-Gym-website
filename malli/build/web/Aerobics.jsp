...
<div class="pic" >
    <td><img src="pics/Aerobics.jpg" alt="Aerobics"/></td>   
    <table border="2" align="center">
        <tr><h1 >Aerobics</h1></tr>
        <tr>
        ...
        <%
            ...
            try{                
                ...
                i = st.executeQuery("select * from trainee where traineetype='Aerobics'");
            }
            catch(Exception e){
        ...
        <tr>
            ...
            <td><%=i.getString("traineename") %></td>
            <td><%=i.getString("traineeid") %></td>
            <td><%=i.getString("traineetype") %></td>
            <td><%=i.getString("message") %></td>
