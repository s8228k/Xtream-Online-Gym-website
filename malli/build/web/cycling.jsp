...
<div class="pic" >
    <td><img src="pics/Cycling.jpg" alt="Cycling"></td>
    <table border="2" align="center">
        ...
        <%
            ...
            String sql ="(select * from scheduledaytime where scheduleId='A004')";
    ...
    <button style="width:100px;height: 50px;background-color: black;color: snow" onclick="location.href='CyclingInsert.jsp'">Book</button>
</div>
