...
<html>
    ...
    <body>
        <% String price = request.getParameter("price");
           ...
           float payment = Payment.CalculateDeductingPayment(Price);
           out.println(payment);
        %>
            ...
            <tr>
                ...
                <td>
                   ...
                   <table align="center">
                    ...
                    <tr>                <td><button style="width:100px;height: 50px;background-color: black;color: snow" type="submit" name="edit" onclick="location.href='CartInsert.jsp'">Back</button></td></tr>
                </table>
