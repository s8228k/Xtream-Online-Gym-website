...
<div class="pic" >
    <td><img src="pics/bodytone.jpg" alt="BodyTone"/></td>   
    <table border="2" align="center">
        <tr><h1 >BodyTone</h1></tr>
        <tr>
            <td>Schedule Day</td>
            <td>Start Time </td>
            <td>End Time </td> 
        ...
        <%
            ...
            String sql ="(select * from scheduledaytime where scheduleId='A001')";
    ...
    <button style="width:100px;height: 50px;background-color: black;color: snow" onclick="location.href='BodyToneiInsert.jsp'">Book</button>
</div>
