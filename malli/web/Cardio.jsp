...
<div class="pic" >
    <td><img src="pics/Cardio.jpg" alt="Cardio"></td>
    <table border="2" align="center">
        ...
        <%
            ...
            String sql ="(select * from scheduledaytime where scheduleId='A005')";
    ...
    <button style="width:100px;height: 50px;background-color: black;color: snow" onclick="location.href='CardioInsert.jsp'">Book</button>
</div>
