...
<div class="pic" >
    <td><img src="pics/Legs,Bums,Tums.jpg" alt="Legs,Bums,Tums.jpg"></td>
     <table border="2" align="center">
        <tr><h1 >Legs,Bums,Tums</h1></tr>
        <tr>
            <td>Schedule Day</td>
            <td>Start Time </td>
            <td>End Time </td> 
        ...
        <%
            ...
            String sql ="(select * from scheduledaytime where scheduleId='A003')";
    ...
    <button style="width:100px;height: 50px;background-color: black;color: snow" onclick="location.href='LegsBumsTumsInsert.jsp'">Book</button>
</div>
