    ...
    <center>
        ...
        <table border="1" cellspacing="5" cellpadding="4" style="border-style:solid;">
            ...
            <tbody>
                <%
                    while (result.next()){
                        paymentId=result.getInt("paymentId");
                %>
                <tr>
                    
                    <td><%=result.getString("paymentId")%></td>
                    <td><%=result.getString("username")%></td>
                    <td><%=result.getString("date")%></td>
                    <td><%=result.getString("TotalPayment")%></td>
                    <td><a href="deletePaymentDetails.jsp?id=<%=paymentId%>" onclick="return confirm('Are you Sure?')">Delete</a></td>
                </tr>
                <%
                    }
                %> 
